 ...
 * Sample Test Code for Task 6.
 *
 * This must be compiled with your implementation of Task 6 which is in editor.c
 * To compile:
 *     gcc editor.c t6test.c -o t6test
 *
 * If everything goes well, this will generate an executable file t6test.
 */
...
int main(void)
{
    ...
    printf("Sample test for Task 6\n");

    printf("----------------------\n");
    strcpy(editing_buffer, "The quick brown fox");
    printf("Initial  buffer contents: %s\n", editing_buffer);
    printf("Call: editor_replace_str(editing_buffer, 21, \"brown\", \"blue\", "
           "0);\n");
