 ...
 * Sample Test Code for Task 7.
 *
 * This must be compiled with your implementation of Task 7 which is in editor.c
 * To compile:
 *     gcc editor.c t7test.c -o t7test
 *
 * If everything goes well, this will generate an executable file t7test.
 */
