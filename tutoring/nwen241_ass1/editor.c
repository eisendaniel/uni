 ...
 * Consult the assignment handout for the detailed specifications of each of the
 * functions.
 *
 * Student ID:
 * Name:
                       ...
                       char to_insert, int pos)
{
    ...
    /* Although not strictly required by the assignment,
     * null-terminating the editing buffer makes everything a lot
     * easier.
     *
     * THIS MAY CONFLICT WITH STUDENT SOLUTIONS! In general, this can be
     * solved by adding the following line to student code.
     */
