...
\begin{preview}
      ...
      \begin{enumerate}
            ...
            \item Test it:
                  ...
                  \end{center}
            \item Analog circuits funky
            \item The LM319 is a duel chip, flip the input for the second and pull up its output to get an inverted signal
            \item Sub-circuits: Gain Amp Oscillator and Integrator 
      \end{enumerate}
      \hrule
\end{preview}
