...
#
# Generated by Vivado on Thu Sep 17 11:27:48 +1200 2020
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../blocky_mono_bass.srcs/sources_1/bd/design_1/ipshared/8b3d" \
  ...
  vlogan -work dist_mem_gen_v8_0_13 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../blocky_mono_bass.srcs/sources_1/bd/design_1/ipshared/8b3d" \
    "$ref_dir/../../../../blocky_mono_bass.srcs/sources_1/bd/design_1/ip/design_1_PWMAudio_0_0/src/dist_mem_gen_0/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../blocky_mono_bass.srcs/sources_1/bd/design_1/ipshared/8b3d" \
    "$ref_dir/../../../bd/design_1/ip/design_1_PWMAudio_0_0/src/dist_mem_gen_0/sim/dist_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/design_1/ipshared/7180/src/PWMDriver.vhd" \
    "$ref_dir/../../../bd/design_1/ipshared/7180/src/PWMAudio.vhd" \
    "$ref_dir/../../../bd/design_1/ip/design_1_PWMAudio_0_0/sim/design_1_PWMAudio_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
