...
HD_PWD='H:/private/projects/ECEN302/tuts/Lab tute 6/lab4_mealyFSM/lab4_mealyFSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_Mealy1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_Mealy1.tcl
