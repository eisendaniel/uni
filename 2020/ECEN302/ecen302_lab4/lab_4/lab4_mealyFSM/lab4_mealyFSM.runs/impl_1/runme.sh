...
HD_PWD='H:/private/projects/ECEN302/tuts/Lab tute 6/lab4_mealyFSM/lab4_mealyFSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_Mealy1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_Mealy1.tcl -notrace
