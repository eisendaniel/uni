...
;Timer - counter interrupt service routine ISR
TINT:		CLR 	TR0 			//stopping timer
		CLR 	TF0			//clear interrupt flag
		MOV	TH0,#0x3C		//reset timer values
		MOV	TL0,#0xB0
		SETB 	TR0			//restart timer
		DJNZ 	R0, TINTE		//if RO - 1 == 0, return from interupt
		MOV 	R0, #20			//else, set r0 to 20
		CPL 	P2.3			//flip pin 2.3
		ACALL 	INCT			//increment clock
